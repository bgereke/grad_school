function [window] = decodewindows_v2(cellist,window)
%to get TFR during each window
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%more parameters and go through all windows
for kk = 1:size(window,1)
    tstart = window{kk,2}(1,1);
    numsteps = (window{kk,2}(1,2)-tstart)/step;
    minspikes = 1;
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for k = 1:numsteps
        ...
        [Px] = probXV(Px,xL,smooth(v,15),xfin(k,4),binsize);
    ...
    window{kk,12} = Pxn;
    window{kk,13} = actualxbin;
    window{kk,14} = xbins;
    window{kk,15} = tbin;clear tbin;
end
