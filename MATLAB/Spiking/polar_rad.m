function hpol = polar(varargin)
    ...
    if ~hold_state
        ...
        rt = 1.13 * rmax;
        text_strings = {num2str(pi/6)  num2str(pi/3)  num2str(pi/2)  num2str(2*pi/3) num2str(5*pi/6)  num2str(pi) ...
            num2str(-5*pi/6) num2str(-2*pi/3) num2str(-pi/2) num2str(-pi/3) num2str(-pi/6) '0'};
        for i = 1 : length(th)
