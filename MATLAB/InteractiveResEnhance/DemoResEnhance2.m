...
% for a single peak. Displays sliders for separate real-time control of  
% 2nd and 4th derivative weighting factors (factor and factor2) and 
% smooth width. The peak width of the resolution-enhanced peak 
...
% the peak.  Adjust these two factors for the the best compromise. 
