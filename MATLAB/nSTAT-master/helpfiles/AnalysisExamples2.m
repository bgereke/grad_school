...
% could just define velocity = position.derivative;
...
% [fitResults,tcc] = Analysis.computeHistLag(trial,neuronNum,windowTimes,covLabels,Algorithm,batchMode,sampleRate,makePlot,histMinTimes,histMaxTimes);
