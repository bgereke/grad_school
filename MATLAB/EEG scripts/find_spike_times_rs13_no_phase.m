function [eeg_epoch_index2] = find_spike_times_rs13_no_phase(TS_spikes, ts_eeg, EEG, Fs)
...
%     eeg_epoch_index = (512 * eeg_index_boundary) + samples_conv;
    ...
    elseif eeg_epoch_index > (length(EEG)-631)
        ...
        %eeg_epoch_to_insert = EEG(eeg_epoch_index - 631: eeg_epoch_index + 631);
        ...
        %sPhase = [sPhase,phase(eeg_epoch_index)];
